...
💡 <b>Совет:</b> Сначала уточните наличие товара, а потом оформляйте заказ — так будет удобнее!

⚙️ <b>Команды:</b>
/help — справка по работе с ботом
/clear — начать диалог заново (если бот запутался или нужно сменить тему)"""
...
• «Есть черника?» — проверю наличие
• «Что есть из ягод?» — покажу категорию
• «Сколько стоит малина?» — скажу цену

<b>Оформить заказ:</b>
• «Хочу чернику 10 кг» — начну оформление
• «Закажу малину 5 кг и клубнику 3 кг»
...
<b>Когда использовать /clear:</b>
• Бот отвечает невпопад или путается
• Хотите начать разговор с чистого листа
• Переключаетесь на совсем другую тему

💡 Я запоминаю наш диалог, так что можете уточнять: «а в каком виде?», «а цена?»

Если что-то непонятно — просто спросите по-другому, и я постараюсь помочь!"""
...
async def show_catalog(message: Message) -> None:
    ...
    try:
        ...
        response += "💡 <i>Напишите название товара, чтобы узнать подробнее или оформить заказ</i>"
